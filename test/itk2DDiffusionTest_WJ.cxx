...
#include "mad/itkMultigridWeightedJacobiSmoother.h"


int itk2DDiffusionTest_WJ( int argc, char * argv[] )
{
  ...
  typedef itk::mad::MultigridWeightedJacobiSmoother< ImageType::ImageDimension > smootherType;
